<template>
  <div class="detective_statistics">
    	...
    	<template>
	 			<el-table :data="tableData" border stripe highlight-current-row style="width: 100%;" v-loading="listLoading">
		 				...
		 				<el-table-column prop="cameraOnline" label="神探在线率" align="center"></el-table-column>
		 				<el-table-column prop="cameraOffline" label="神探离线率" align="center"></el-table-column>
		 				<el-table-column prop="cameraAbnormal" label="神探异常率" align="center" ></el-table-column>
    	...
    	<!--图表分析-->
		 <el-dialog title="图表" :visible.sync="echartDialog">
		 			<el-row>
		 					<el-col :span="24" class="bg-purple" align="center" >{{echartDialogTitle}}神探统计情况</el-col>
...
<script>
	import { getDetecitveStatisticsTable } from 'api'
	import echarts from 'echarts'
export default {
  name: 'detective_statistics',
  data () {
    return {
...
//		let userData = this.$store.getters.getUserData;
  		...
  		getDetecitveStatisticsTable(para).then((res) =>{
                  ...
                  series:[  //图形配置
                  	{
                  		...
                  		data:[ //数据
                  			{name: '在线率', value:row.onlineNum },
                  			{name: '离线率', value:row.offlineNum },
                  			{name: '异常率', value:row.abnormalNum }
                  		]
                  	}
                  ],
