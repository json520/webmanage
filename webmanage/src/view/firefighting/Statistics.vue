<template>
  <div class="firefighting_statistics">
    	...
    	<template>
	 			<el-table :data="tableData" border stripe highlight-current-row style="width: 100%;" v-loading="listLoading">
		 				...
		 				<el-table-column prop="putCybercafeNum" label="已上传网吧数量" align="center"></el-table-column>
		 				<el-table-column prop="unPutCybercafeNum" label="未上传网吧数量" align="center"></el-table-column>
		 				<el-table-column prop="qualifiedProbability" label="合格率" align="center" ></el-table-column>
		 				<el-table-column prop="dateTime" label="自查时间" align="center" :formatter="formatterTableDateTime"></el-table-column>
			 ...
			 <el-dialog title="图表" :visible.sync="echartDialog">
			 			<el-row>
			 					<el-col :span="24" class="bg-purple" align="center" >{{echartDialogTitle}}消防自查合格情况</el-col>
...
import { getFirefightingStatisticsTable } from 'api'	
import echarts from 'echarts'
export default {
  name: 'firefighting_statistics',
  data () {
    return {
  ...
  methods:{
  	...
  	getUsers(){
  		...
  		getFirefightingStatisticsTable(para).then((res) =>{
                  ...
                  series:[  //图形配置
                  	{
                  		...
                  		data:[ //数据
                  			{name: '合格', value:row.putCybercafeNum },
                  			{name: '不合格', value:row.unPutCybercafeNum }
                  		]
                  	}
                  ],
