  ...
  <div class="video_patrol">
    	...
    	<template>
	 			<el-table :data="tableData" border stripe highlight-current-row style="width: 100%;" v-loading="listLoading">
		 				...
		 				<el-table-column prop="endPatrolCybercafe" label="已巡查网吧数" align="center"></el-table-column>
		 				<el-table-column prop="partPatrolCybercafe" label="部分巡查网吧数" align="center"></el-table-column>
		 				<el-table-column prop="nonePatrolCybercafe" label="未巡查网吧数" align="center" ></el-table-column>
		 				<el-table-column prop="endPatrolCamera" label="已巡查监控数" align="center" ></el-table-column>
		 				<el-table-column prop="nonePatrolCamera" label="未巡查监控数" align="center" ></el-table-column>
		 				<el-table-column prop="dateTime" label="日期"  width="180" align="center" :formatter="formatterTableDateTime" ></el-table-column>
	 			</el-table>
 			</template>
 			<!--分页-->
...
<script>
	import {getVideoPatrolTable } from 'api'
...
export default {
  ...
  methods:{
  	...
  	getUsers(){
  		...
  		getVideoPatrolTable(para).then((res) =>{
